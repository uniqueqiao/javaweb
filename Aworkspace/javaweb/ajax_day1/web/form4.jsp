    ...
    <script type="text/javascript">
        $(function() {
            $("#username").blur(function() {
                $("#mess1").remove();
                $("#image").prop("src","img/load.gif").css("width","20px").css("height","20px");
                //发送ajax异步请求
                //1.创建异步请求对象
                var xhr;
...
<body>
    <form method="post" >
      username<input type="text" name="username" id="username"/><span id="mess1">*</span><img src="" id="image"/><br><br>
