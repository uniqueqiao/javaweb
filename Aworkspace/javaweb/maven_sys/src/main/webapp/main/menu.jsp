        ...
        <div class="col-sm-12">
            <ul class="list-group">
                ...
                <%--<c:if test="${sessionScope.user.role=='admin'}">--%>
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/" target="main">小组管理</a></li>
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/" target="main">班级管理</a></li>
